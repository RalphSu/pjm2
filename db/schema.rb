...
ActiveRecord::Schema.define(:version => 20140528171810) do
  ...
  create_table "crawler_jobs", :force => true do |t|
    ...
    t.datetime "updated_at"
    t.string   "init_url"
    t.datetime "search_query_begin_date"
    t.datetime "search_query_end_date"
  end
  ...
  add_index "journals", ["journaled_id"], :name => "journals_journalized_id"
  ...
  create_table "report_templates", :force => true do |t|
    ...
    t.datetime "updated_at"
    t.integer  "project_id",    :null => false
    t.string   "classified",    :null => false
  end
